...
export default function Experiences() {
  return (
    <div id='experiencies' className='container shadow-md border-[2px] rounded-md mx-auto p-4 flex flex-col justify-center items-center lg:justify-between lg:flex-row gap-2 lg:p-8 mt-12 '>
    <div>
    <div className='flex justify-start items-center p-2 ml-2 gap-2 text-lg font-bold py-2 border-b-[2px] border-[#1e1e1e] w-[300px] lg:w-[500px] '>
     ...
     <p className='text-[#01377d] lg:text-2xl'>WORK EXPERIENCE</p>
      ...
      <p className='text-left p-2 font-semibold text-[#1e1e1e] ml-2'>
      Intern at Cylex company <br />
      Position: Front End Developer
     </p>
     </div>

        <img className='w-[200px] p-4' src="/assets/exp.png" alt="" />
