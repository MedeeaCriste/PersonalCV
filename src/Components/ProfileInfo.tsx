...
export default function ProfileInfo() {
  return (
    <div id='pinfo' className='container shadow-md rounded-md mx-auto p-4 flex flex-col justify-center items-center lg:justify-between lg:flex-row gap-2 lg:p-8 mt-12 '>
      <div  >
       <div className='flex justify-start items-center p-2 ml-2 gap-2 text-lg font-semibold py-2 border-b-[2px] border-[#1e1e1e] w-[300px] lg:w-[500px] '>
        ...
        <p className='text-[#01377d] lg:text-2xl'>PROFILE INFO</p>
         ...
         <p className='text-left p-2 text-[#009dd1] ml-2'>As a computer science student, I'm eager to expand my
