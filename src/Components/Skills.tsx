...
export default function Skills() {
    return (
        <div id='skills' className='container bg-white shadow-md border-[2px] rounded-md mx-auto p-4 flex flex-col justify-center items-center lg:justify-between lg:flex-row gap-2 lg:p-8 mt-12 '>
        <div>
        <div className='flex justify-start items-center p-2 ml-2 gap-2 text-lg font-bold py-2 border-b-[2px] border-[#1e1e1e] w-[300px] lg:w-[500px] '>
         ...
         <p className='text-[#01377d] lg:text-2xl'>MY SKILLS & EXPERTISE</p>
          ...
          <p className='text-left p-2 text-[#1e1e1e] font-semibold ml-2'>
          React, Next.js <br />
          Html, <br />
          CSS, Javascript <br />
          Tailwind CSS <br />
