...
export default function Volunteering() {
    return (
        <div id='volunteering' className='container border-[2px] shadow-md rounded-md mx-auto p-4 flex flex-col justify-center items-center lg:justify-between lg:flex-row gap-2 lg:p-8 mt-12 '>
        <div>
